...
async def search_movie(request: Request):
    return templates.TemplateResponse("search.html", {"request": request, 'omdb_key': settings.api_keys.omdb})
...
async def movie_details(request: Request, film_id: str):
    ...
    return templates.TemplateResponse(
        "movie.html", {"request": request, "movie": movie, 'omdb_key': settings.api_keys.omdb}
    )
